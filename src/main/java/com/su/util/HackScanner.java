 ...
 * 2. 几个方法的返回参数类型：java.util.Scanner -> com.su.HackScanner
 *
...
public final class HackScanner implements Iterator<String>, Closeable {
     ...
     * @return this scanner
     */
    public com.su.util.HackScanner useDelimiter(Pattern pattern) {
        delimPattern = pattern;
        return this;
    }
     ...
     * @return this scanner
     */
    public com.su.util.HackScanner useDelimiter(String pattern) {
     ...
     * @return this scanner
     */
    public com.su.util.HackScanner useLocale(Locale locale) {
     ...
     */
    public com.su.util.HackScanner useRadix(int radix) {
     ...
     * @throws IllegalStateException if this scanner is closed
     */
    public com.su.util.HackScanner skip(Pattern pattern) {
        ensureOpen();
        if (pattern == null)
            throw new NullPointerException();
        clearCaches();
     ...
     * @throws IllegalStateException if this scanner is closed
     */
    public com.su.util.HackScanner skip(String pattern) {
     ...
     * @since 1.6
     */
    public com.su.util.HackScanner reset() {
